...
interface LatestBlogPageProps {
  initialBlogs: BlogItem[];
  initialSettings: ApiSettings;
}

export function LatestBlogPage({ initialBlogs, initialSettings }: LatestBlogPageProps) {
              ...
              <div className="lg:sticky lg:top-20 space-y-4">
                ...
                <div className="bg-gradient-to-br from-navy to-[#0F203A] border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.15)] ring-1 ring-white/5 rounded-2xl p-5 relative overflow-hidden group">
                  ...
                  <div className="relative z-10">
                    ...
                    <a
                      href={initialSettings.telegramLink}
                      target="_blank"
                    ...
                    <a
                      href={initialSettings.whatsappLink}
                      target="_blank"
                      rel="noopener noreferrer"
