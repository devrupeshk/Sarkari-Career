              ...
              <FadeIn delay={0.2}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                  <a
                    ...
                    className="group relative overflow-hidden flex items-center justify-between p-4 rounded-2xl border border-emerald-500/15 bg-gradient-to-br from-emerald-500/[0.03] to-teal-500/[0.01] hover:from-emerald-500/[0.06] hover:to-teal-500/[0.03] transition-all duration-300 hover:-translate-y-0.5 shadow-sm shadow-emerald-500/5 hover:shadow-emerald-500/12"
                  >
                    ...
                    <div className="flex items-center gap-1.5 bg-emerald-500 hover:bg-emerald-600 text-white font-black text-[10px] tracking-wider px-3.5 py-2.5 rounded-xl transition-colors duration-200 shadow-sm shadow-emerald-500/10 shrink-0 relative z-10">
                      JOIN GROUP
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group relative overflow-hidden flex items-center justify-between p-4 rounded-2xl border border-sky-500/15 bg-gradient-to-br from-sky-500/[0.03] to-blue-500/[0.01] hover:from-sky-500/[0.06] hover:to-blue-500/[0.03] transition-all duration-300 hover:-translate-y-0.5 shadow-sm shadow-sky-500/5 hover:shadow-sky-500/12"
                  >
                    ...
                    <div className="flex items-center gap-1.5 bg-sky-500 hover:bg-sky-600 text-white font-black text-[10px] tracking-wider px-3.5 py-2.5 rounded-xl transition-colors duration-200 shadow-sm shadow-sky-500/10 shrink-0 relative z-10">
                      JOIN NOW
